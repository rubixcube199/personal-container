...
echo
	...
	axylosVersion='rolling'

	isoLabel='axylos-'$axylosversion'-x86_64.iso'
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="AxylOS"'
	newname1='iso_name="AxylOS"'

	oldname2='iso_label="AxylOS"'
	newname2='iso_label="AxylOS"'
